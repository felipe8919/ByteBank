...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente : IComparable
    {
        ...
        /// <summary>
        /// Cria uma instância de ContaCorrente com os argumentos utilizado.
        /// </summary>
        ...
        /// </summary>
        /// <exception cref="ArgumentNullException"> Exceção lançada quando um valor negativo é utilizado no argumento <paramref name="valor"/>. </exception>
        ...
        public int CompareTo(object obj)
        {
            ...
            // Retornar zero quanto nossa instância e obj forem equivalentes;
            // Retornar porsitivo diferente de zero quando a precedencia for de obj;
